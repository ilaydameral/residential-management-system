...
export const TURKEY_CITIES: CityData[] = [
  ...
  { name: 'Afyonkarahisar', districts: ['Başmakçı', 'Bayat', 'Bolvadin', 'Çay', 'Çobanlar', 'Dinar', 'Emirdağ', 'Evciler', 'Hocalar', 'İhsaniye', 'İscehisar', 'Kızılören', 'Merkez', 'Sandıklı', 'Sinanpaşa', 'Sultandağı', 'Şuhut'] },
  ...
  { name: 'Giresun', districts: ['Alucra', 'Bulancak', 'Çamoluk', 'Çanakçı', 'Dereli', 'Doğankent', 'Espiye', 'Eynesil', 'Görele', 'Güce', 'Keşap', 'Merkez', 'Piraziz', 'Görele', 'Şebinkarahisar', 'Tirebolu', 'Yağlıdere'] },
  ...
  { name: 'Ordu', districts: ['Akkuş', 'Altınordu', 'Aybastı', 'Çamaş', 'Çatalpınar', 'Çaybaşı', 'Fatsa', 'Gölköy', 'Gülyalı', 'Gürgentepe', 'İkizce', 'Kabadüz', 'Kabataş', 'Korgan', 'Kumru', 'Mesudiye', 'Ünye', 'Ulubey', 'Fatsa'] },
  ...
  { name: 'Sinop', districts: ['Boyabat', 'Dikmen', 'Durağan', 'Erfelek', 'Gerze', 'Merkez', 'Saraydüzü', 'Türkeli'] },
  ...
  { name: 'Tunceli', districts: ['Çemişgezek', 'Hozat', 'Mazgirt', 'Nazımiye', 'Ovacık', 'Pertek', 'Pülümür', 'Merkez'] },
...
/**
 * Normalizes Turkish text for case-insensitive and diacritic-insensitive search comparison.
 * Maps 'ç' -> 'c', 'ğ' -> 'g', 'ı' -> 'i', 'ö' -> 'o', 'ş' -> 's', 'ü' -> 'u', 'İ' -> 'i', 'I' -> 'i', etc.
 */
