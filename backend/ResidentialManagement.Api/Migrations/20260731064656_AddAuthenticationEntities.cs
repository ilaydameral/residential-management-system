    ...
    public partial class AddAuthenticationEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ADMIN", "Full system administration access", true, "Administrator" },
                    { 2, "MANAGER", "Manages assigned properties and operational records", true, "Property Manager" },
                    { 3, "USER", "Basic authenticated system access", true, "Standard User" }
                });
